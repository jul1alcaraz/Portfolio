/* empty css                          */
import { e as createAstro, f as createComponent, r as renderTemplate, m as maybeRenderHead, h as addAttribute, i as renderComponent, j as renderHead, k as renderSlot } from '../astro_BbUtqma4.mjs';
import 'kleur/colors';
import 'html-escaper';
import 'clsx';
...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Header;
  return renderTemplate`${maybeRenderHead()}<nav class="menu-header"> <a href="/" class="site-title"> <img class="rounded-full w-12 h-12" src="../../public/flower_icon_134982.ico" alt="Julieta Alcaraz foto" style="filter: brightness(0) invert(1)">Julieta Alcaraz
...
MIS <br>
PROYECTOS
</h1> </div> <div class="absolute  lg:left-1/2 lg:top-1/2 lg:-translate-y-1/2 lg:translate-x-8"> <div class="h-screen lg:gap-y-8"> <div class="flex justify-center image-container"> <figure class="grayscale hover:grayscale-0"> <a href="https://puma-store-ten.vercel.app/"> <img src="../../public/logo-puma.jpg" alt="Puma Oulet" class="h-full w-full object-center duration-300 cursor-pointer filter grayscale hover:grayscale-0"> </a> <figcaption class="encabezado absolute px-4 text-lg text-white bottom-6 right-6"> <p class="hover-text2">Diseño Web Ecommerce.</p> <p class="hover-text">
Desarrollado con React + NodeJS + MongoDB + Material
</p> </figcaption> </figure> </div> <div class="flex justify-center image-container"> <figure class="grayscale hover:grayscale-0"> <a href="https://harmed-roars.000webhostapp.com/index.php"> <img src="../../public/ra.logo.png" alt="Rescate Animal" class="h-full w-full object-center duration-300 cursor-pointer filter grayscale hover:grayscale-0"> </a> <figcaption class="encabezado absolute px-4 text-lg text-black top-6"> <p class="hover-text2">Página web de concientización animal.</p> <p class="hover-text">
...
const $$Contacto = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="fondo-contacto"> <h2 class="subTituloC">${content.title_contacto}</h2> <div class="flex flex-wrap justify-center gap-36"> <div class="max-w-60 imgContacto"> <div class="flex flex-col items-center pb-5 bg-white rounded-t-full"> <a href="https://github.com/jul1alcaraz"> <img class="CardConta" src="../../public/git.png"> </a> <h5 class="mb-1 text-xl font-medium text-gray-900">GitHub</h5> <span class="text-sm text-gray-500">/jul1alcaraz</span> </div> </div> <div class="max-w-60 imgContacto"> <div class="flex flex-col items-center pb-5 bg-white rounded-t-full"> <a href="https://www.linkedin.com/in/jul1alcaraz/"> <img class="CardConta" src="../../public/In.png"> </a> <h5 class="mb-1 text-xl font-medium text-gray-900">LinkedIn</h5> <span class="text-sm text-gray-500">/jul1alcaraz</span> </div> </div> <div class="max-w-60 imgContacto"> <div class="flex flex-col items-center pb-5 bg-white rounded-t-full"> <a href="mailto:Lic.alcarazaballay2022@gmail.com"> <img class="CardConta" src="../../public/gmail.png"> </a> <h5 class="mb-1 text-xl font-medium text-gray-900">Gmail</h5> <span class="text-sm text-gray-500">lic.alcarazaballay2022@gmail.com</span> </div> </div> </div> </div>`;
